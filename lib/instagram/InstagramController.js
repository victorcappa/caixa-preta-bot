...
export class InstagramController {
  ...
  async searchPublicWeb(query, { preferGoogle = true } = {}) {
    if (preferGoogle) {
      await this.page.goto(`https://www.google.com/search?q=${encodeURIComponent(query)}&hl=pt-BR`, {
    ...
    await this.page.goto(`https://www.bing.com/search?q=${encodeURIComponent(query)}&setlang=pt-br`, {
      waitUntil: "domcontentloaded",
      timeout: 20000
    });
    await this.page.waitForTimeout(1200);
