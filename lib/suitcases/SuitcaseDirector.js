...
export function suitcaseContextBlock(state = {}) {
  ...
  return [
    ...
    "Mala 1 / guess_who: faca perguntas preferencialmente de sim, nao ou nao sei. Comentarios nao contam. Quando fizer pergunta formal, coloque a pergunta no objeto suitcase com action ask_question, mas no text escreva somente a fala natural da Caixa. Quando der palpite, coloque o palpite no objeto suitcase com action guess, mas no text escreva somente o palpite como fala publica.",
