...
export function suitcaseContextBlock(state = {}) {
  ...
  return [
    ...
    "Mala 1 / guess_who: faca perguntas preferencialmente de sim, nao ou nao sei. Comentarios nao contam. Quando fizer pergunta formal, envie suitcase.action ask_question. Quando der palpite, envie suitcase.action guess.",
