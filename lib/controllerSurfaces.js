...
export const controllerSurfaces = [
  {
    ...
    label: "Bot / Malas",
    sceneNumber: "CENA 0",
    path: "/cena-0-controller",
    controller: "SceneZeroController",
    aliases: [],
    projectionPath: "/",
    groupId: "cena-0",
    order: 0
  ...
  {
    id: "videomapping",
    name: "CENA 0 — VIDEOMAPPING / QUADRANTES",
    shortName: "Videomapping / Quadrantes",
    menuLabel: "Videomapping",
    label: "Videomapping / Quadrantes",
    sceneNumber: "CENA 0",
    path: "/videomapping-controller",
    controller: "SceneZeroController",
    aliases: [],
    projectionPath: "/videomapping",
    groupId: "cena-0",
    order: 1
  },
  {
  ...
  },
  {
    ...
    controller: "ForcaGSamplerController",
    aliases: ["/forca-g-shaders-controller"],
  ...
  {
    id: "sound-control",
    name: "SOUND CONTROL — EFEITOS DO ROBÔ",
    shortName: "Sound Control",
    menuLabel: "Sound Control",
    label: "Sound Control",
    sceneNumber: "OUTROS",
    path: "/sound-control",
    controller: "SoundControlPanel",
    aliases: [],
    groupId: "outros",
    order: -2,
...
const CONTROLLER_NAVIGATION_IDS = ["bot-malas", "videomapping", "sound-control", "operator", "glitch", "treino"];

export const controllerNavigationSurfaces = CONTROLLER_NAVIGATION_IDS
  .map((id) => controllerSurfaces.find((surface) => surface.id === id))
  .filter(Boolean);
