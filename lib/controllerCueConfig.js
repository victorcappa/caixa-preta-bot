...
const SCENE_ONE_AUDIO_LABELS = {
  "Alarms, T-CAS and GPWS of Boeing 737.mp3": "Alarmes Boeing 737",
  "Saudia Flight 163 - Accident Animation (Original Sound).mp3": "Saudia 163",
  "alarme-tututu.mp3": "Alarme Tututu",
  "bank-angle.mp3": "Bank Angle",
  "buzzer.mp3": "Buzzer",
  "caution-terrain.mp3": "Caution Terrain",
  "pull-up.mp3": "Pull Up",
  "queda-completa.mp3": "Queda Completa",
  "radio-e-alarme.mp3": "Rádio e Alarme",
  "sinal-continuo.mp3": "Sinal Contínuo",
  "uauaua.mp3": "Uauaua"
};
  ...
  try {
    return fs.readdirSync(directory, { withFileTypes: true })
      ...
      .map((filename, index) => cue(
        SCENE_ONE_AUDIO_LABELS[filename] || path.basename(filename, path.extname(filename)).replace(/[-_]+/g, " "),
        "",
        "audio",
