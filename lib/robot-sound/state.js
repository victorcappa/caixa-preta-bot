...
export const ROBOT_DISPLAY_FONTS = {
  "modern-dos-8x16": "MODERN DOS 8×16",
  "modern-dos-9x16": "MODERN DOS 9×16",
  vt323: "VT323 / TERMINAL",
  courier: "COURIER / ORIGINAL"
};
export const ROBOT_DISPLAY_FONT_NAMES = Object.keys(ROBOT_DISPLAY_FONTS);
export const ROBOT_DISPLAY_FONT_DEFAULT = "modern-dos-8x16";
...
export const ROBOT_SOUND_DEFAULTS = {
  ...
  typingIntervalMs: 60,
  displayFont: ROBOT_DISPLAY_FONT_DEFAULT,
  preset: "normal",
...
export function normalizeRobotSoundSettings(settings = {}, base = ROBOT_SOUND_DEFAULTS) {
  ...
  return {
    ...
    displayFont: ROBOT_DISPLAY_FONT_NAMES.includes(settings.displayFont)
      ? settings.displayFont
      : ROBOT_DISPLAY_FONT_NAMES.includes(base.displayFont)
        ? base.displayFont
        : ROBOT_DISPLAY_FONT_DEFAULT,
    preset,
