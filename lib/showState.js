...
import {
  ...
  SCENE_ZERO_RETURN_BORROWED_OBJECTS_INSTRUCTION,
...
const STORE_VERSION = "scene-zero-hangman-theme-audio-sink-v16";
...
function createStore() {
  ...
  function scheduleSceneZeroGincanaTimer() {
    ...
    if (delay === 0) {
      ...
      publishSceneZeroReturnBorrowedObjectsInstruction();
  ...
  function publishSceneZeroReturnBorrowedObjectsInstruction() {
    const gincana = ensureSceneZeroSuitcaseGame().gincana;
    if (gincana.lastComment === SCENE_ZERO_RETURN_BORROWED_OBJECTS_INSTRUCTION) return null;
    gincana.lastComment = SCENE_ZERO_RETURN_BORROWED_OBJECTS_INSTRUCTION;
    return addMessage(
      "assistant",
      SCENE_ZERO_RETURN_BORROWED_OBJECTS_INSTRUCTION,
      "scene-zero-return-objects"
    );
  }
