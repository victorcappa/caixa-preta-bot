...
function createStore() {
  ...
  function controlAudienceWarmup(action, payload = {}, { source = "operator" } = {}) {
    ...
    if (action === "select-action") {
      ...
      clearAudienceWarmupTimer();
      const sequence = createAudienceWarmupSequence({ text: prompt.text, action: current.selectedAction, countdown: prompt.countdown });
      ...
      clearAudienceWarmupTimer();
      const sequence = createAudienceWarmupSequence({ text: prompt.text, action: prompt.action, countdown: prompt.countdown });
