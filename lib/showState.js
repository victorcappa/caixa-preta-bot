...
const STORE_VERSION = "audience-warmup-fixed-five-progress-v5";
...
function createStore() {
  ...
  function startHumanVerificationIntro() {
    ...
    appendSceneZeroAction("human-verification-title", PLAY_UNLOCK_CONFIG.verificationTitle);
    emitPlayUnlock("play-unlock-human-verification");
    armAudienceWarmupAdvance("questions-start", {}, PLAY_UNLOCK_CONFIG.verificationTitleDurationMs, "INICIAR PERGUNTAS");
    return true;
  }
