...
export const PUBLIC_LAYOUT_CHANGE_EVENT = "caixa-preta:public-layout";
...
export function getPublicLayoutByPath(path = "") {
  const pathname = normalizeProjectionPath(path);

  if (pathname === "/videomapping") {
    return PUBLIC_LAYOUTS.quadrants;
  }

  if (pathname === "/") {
    return PUBLIC_LAYOUTS.principal;
  }
