  ...
  const unlockContext = unlock.status !== PLAY_UNLOCK_STATES.UNLOCKED
    ? [
      ...
      unlock.status === PLAY_UNLOCK_STATES.STANDBY
        ...
        : "A BIOS parou no limite previsto. O aquecimento pode continuar, mas a barra permanece fixa até o encerramento real do Jogo das Malas.",
      "Somente o evento de fim do Jogo das Malas preenche a barra até 100% e inicia o desbloqueio.",
