...
export function buildSceneZeroDirection(sceneZero, action, detail = "") {
  ...
  const directions = {
    ...
    suitcase_one_start: "Esta é a terceira e última escolha do robô: MALA 1. Depois da indicação visual, o robô sofre um glitch e uma nova BIOS com fragmentos de Morel ocupa a projeção. Não inicie É Bolo?, Verdade ou Bolo ou outro jogo. Não fale por cima da nova BIOS.",
