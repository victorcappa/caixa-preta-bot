  ...
  const unlockContext = unlock.status !== PLAY_UNLOCK_STATES.UNLOCKED
    ? [
      ...
      unlock.status === PLAY_UNLOCK_STATES.STANDBY
        ...
        : "A BIOS parou em 50%. O operador avalia cada pequena ação do aquecimento e pode aumentar ou diminuir a barra, que nunca ultrapassa 99% nesta etapa.",
      "Somente o evento de fim do Jogo das Malas leva a barra a 100% e inicia o desbloqueio.",
