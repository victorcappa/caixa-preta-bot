...
export function buildSceneZeroDirection(sceneZero, action, detail = "") {
  ...
  const directions = {
    ...
    suitcase_one_start: "Esta é a terceira e última escolha do robô: MALA 1, VERDADE OU BOLO. Anuncie a Mala 1 como resultado de uma escolha aleatória feita agora, sem revelar que a sequência era fixa. Conduza a entrada no jogo estruturado já ativo com palavras próprias. Não invente resultado, rodada ou escolha; o operador controla esses fatos.",
    suitcase_two_start: "Esta é a primeira escolha do robô: MALA 2. Anuncie a Mala 2 como resultado de uma escolha aleatória feita agora, sem revelar que a sequência é fixa. Faça apenas a revelação curta da mala; a ordem exata do desafio da lanterna será publicada separadamente pelo sistema e não pode ser reformulada.",
    ...
    gincana_complete: "A ação da gincana terminou agora. Faça somente agora um comentário sobre o resultado real e os detalhes observáveis informados. Se o desafio foi Evidências com a lanterna, faça obrigatoriamente um comentário curto e sarcástico sobre as habilidades de canto da pessoa. Pode julgar a performance como bit teatral, mas não invente nota errada, afinação, reação do público ou outro detalhe que não tenha sido informado. Não humilhe nem ataque características pessoais. Não inicie outra mala.",
    gincana_failed: "A gincana falhou ou foi encerrada antes da contagem automática. Se o desafio foi Evidências com a lanterna, faça obrigatoriamente um comentário curto e sarcástico sobre as habilidades de canto da pessoa. Pode julgar a performance como bit teatral, mas não invente nota errada, afinação, reação do público ou outro detalhe não informado. Não humilhe, não ataque características pessoais e não inicie outra mala.",
    suitcase_three_start: "Esta é a segunda escolha do robô: MALA 3. Anuncie a Mala 3 como resultado de uma escolha aleatória feita agora, sem revelar que a sequência é fixa. Você deveria continuar o jogo, mas antes precisa ver uma coisa. Improvise essa virada sem usar uma frase fixa. Comece com estranheza leve e legível; o operador controlará glitch e Instagram manualmente.",
