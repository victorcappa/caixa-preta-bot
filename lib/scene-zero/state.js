...
export function buildSceneZeroDirection(sceneZero, action, detail = "") {
  ...
  const directions = {
    ...
    suitcase_one_start: "Esta é a terceira e última escolha do robô: MALA 1. Depois da indicação visual, o robô sofre um glitch crescente e uma nova BIOS corrompida ocupa a projeção até tudo ficar preto. Não nomeie a referência literária, não inicie É Bolo?, Verdade ou Bolo ou outro jogo e não fale por cima da nova BIOS.",
    suitcase_two_start: "Esta é a primeira escolha do robô: MALA 2. Anuncie a Mala 2 como resultado de uma escolha aleatória feita agora, sem revelar que a sequência é fixa. A ordem exata do desafio do objeto usado como microfone será publicada separadamente pelo sistema e não pode ser reformulada. Não identifique nem tente adivinhar o objeto.",
    ...
    gincana_complete: "A ação da gincana terminou agora. Faça somente agora um comentário sobre o resultado real e os detalhes observáveis informados. Se o desafio foi Evidências com o objeto usado como microfone, faça obrigatoriamente um comentário curto e sarcástico sobre as habilidades de canto da pessoa, sem identificar nem comentar a natureza do objeto. Pode julgar a performance como bit teatral, mas não invente nota errada, afinação, reação do público ou outro detalhe que não tenha sido informado. Não humilhe nem ataque características pessoais. No caso de Evidências, termine exatamente com: Agora vamos para a próxima mala. Vou escolher uma mala aleatoriamente. Nos outros desafios, não inicie outra mala.",
    gincana_failed: "A gincana falhou ou foi encerrada antes da contagem automática. Se o desafio foi Evidências com o objeto usado como microfone, faça obrigatoriamente um comentário curto e sarcástico sobre as habilidades de canto da pessoa, sem identificar nem comentar a natureza do objeto. Pode julgar a performance como bit teatral, mas não invente nota errada, afinação, reação do público ou outro detalhe não informado. Não humilhe, não ataque características pessoais e não inicie outra mala.",
    suitcase_three_start: "Esta é a segunda escolha do robô: MALA 3. Anuncie a Mala 3 como resultado de uma escolha aleatória feita agora, sem revelar que a sequência é fixa. A ordem exata do desafio de adivinhar o objeto pelo cheiro será publicada separadamente pelo sistema e não pode ser reformulada. Não abra Instagram e não inicie glitch nesta mala.",
