...
export function buildSceneZeroDirection(sceneZero, action, detail = "") {
  ...
  const directions = {
    ...
    enter_participant: "Abra com a fala exata: Agora preciso de participantes. Levantem a mão. Vocês têm cinco segundos. Deixe espaço para a contagem real.",
    participant_roulette_sequence: "Crie o texto do mini game de seleção. O sorteio é decidido pelo sistema, não por você. Use exatamente este convite: Agora preciso de participantes. Levantem a mão. Vocês têm cinco segundos. Os comentários devem brincar com odds, apostas e chances usando nomes reais da lista, sem afirmar probabilidades verdadeiras nem incentivar aposta com dinheiro. Varie o ritmo e não copie exemplos fornecidos pelo operador.",
