...
export function buildSceneZeroContext(sceneZero) {
  ...
  return [
    ...
    `Malas: estado ${sceneZero.suitcaseGame?.status || "idle"}; atual ${sceneZero.suitcaseGame?.currentSuitcase || "nenhuma"}; anterior ${sceneZero.suitcaseGame?.previousSuitcase || "nenhuma"}; jogo ${sceneZero.suitcaseGame?.currentGame || "nenhum"}.`,
