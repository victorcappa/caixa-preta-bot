...
export const SCENE_ZERO_SECOND_SUITCASE_INSTRUCTION = "Antes de abrir a mala, resolva o enigma com o jogo da forca.";
...
export const SCENE_ZERO_RETRY_DURATION_SECONDS = 10;
export const SCENE_ZERO_HANGMAN_RETRY_COMMENTS = [
  "A FORCA VENCEU. UM CLÁSSICO. MAIS 10 SEGUNDOS PARA NEGOCIAR COM O ALFABETO.",
  "O ALFABETO AINDA ESTÁ NA FRENTE. MAIS 10 SEGUNDOS. USE-OS COM ALGUMA DIGNIDADE."
];
