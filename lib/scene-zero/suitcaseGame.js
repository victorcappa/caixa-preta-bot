...
export const SCENE_ZERO_SUITCASE_ORDER = [1, 2, 3];
...
export const SCENE_ZERO_SUITCASES = {
  1: { id: 1, label: "DESAFIO CONTRA O TEMPO", game: "physical_challenge" },
  2: { id: 2, label: "FORCA / QUEDA", game: "hangman" },
  3: { id: 3, label: "NOVA BIOS", game: "morel_bios" }
};

export function sceneZeroSuitcaseChallenge(suitcaseNumber) {
  return Number(suitcaseNumber) === 1 ? SCENE_ZERO_FIRST_CHALLENGE : null;
}
