    ...
    input: [
      {
        ...
        content: [
          ...
          "Escolha exatamente uma action desta lista: follow, open_profile, comment_latest, follow_and_comment_latest, watch_reels, analyze_current, analyze_profile, analyze_recent_posts, analyze_latest_media.",
          ...
          "Formato: {\"action\":\"analyze_profile\",\"username\":\"marcusgarcia\",\"comment\":\"\",\"question\":\"\"}"
        ].join("\n")
      },
      {
        role: "user",
