    ...
    input: [
      {
        ...
        content: [
          ...
          "Escolha exatamente uma action desta lista: follow, open_profile, comment_latest, follow_and_comment_latest.",
          ...
          "Formato: {\"action\":\"follow\",\"username\":\"marcusgarcia\",\"comment\":\"\"}"
        ].join("\n")
      },
      {
        role: "user",
