  ...
  const response = await getClient().responses.create({
    ...
    input: [{
      ...
      content: [
        ...
        "Responda somente JSON válido. Exemplo com duração: {\"text\":\"...\",\"action\":\"clap|hand|hands|feet|word|sound|silence|look|stand|sit|point|snap|lean|turn|eyes|laugh|gesture|move|group|touch\",\"countdown\":5}"
      ].join("\n")
    }, {
      role: "user",
      content: [
