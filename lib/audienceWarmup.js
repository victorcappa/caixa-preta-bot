...
export const AUDIENCE_WARMUP_SURPRISE_STAGES = ["action", "exposure", "division", "judgment", "contact", "confrontation"];
...
export function createAudienceWarmupSequence({
  ...
  const stepTexts = [text, ...countdownSteps, ...(reactions[action.id] || ["ENTRADA REGISTRADA."])];
  return {
