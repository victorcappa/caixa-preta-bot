...
const requiredPromptMarkers = [
  ...
  "Computador de Coragem",
  "matrizes de comportamento",
  "uma coisa so",
  "Ela ajuda enquanto reclama implicitamente",
...
const simulation = [
  ...
  { turn: 5, publicInput: "as pessoas estao entrando", host: "voces atravessaram chuva para isso. comprometimento ou falta de opcoes. quem veio por escolha levanta a mao; quem veio por logistica ruim fica imovel e assume.", checks: ["usesMemory", "createsAction", "sarcasm", "noPoetry"] },
  ...
  { turn: 7, publicInput: "que tipo de comentario?", host: "um que sirva para alguma coisa. metade da sala vota se isso e coragem ou falta de planejamento. eu aceito injustica estatistica.", checks: ["antiFacilitator", "usesMemory", "createsAction", "sarcasm"] },
  ...
  { turn: 13, publicInput: "Janaina", host: "Janaina virou auditoria. pessima noticia para a neutralidade. Janaina, escolhe: absolve a sala ou piora a acusacao?", checks: ["callback", "createsAction", "gameFictionOnly"] },
  ...
  { turn: 23, publicInput: "quais sao as regras?", host: "regra nova. quem perguntar as regras cria uma. aponta para alguem. essa pessoa vira fiscal de regra ate eu esquecer.", checks: ["noGameExplanation", "gameRule", "createsAction"] },
  ...
  { turn: 33, publicInput: "confirmo", host: "aceitavel. namorado confirmado sem auditoria externa. ele confirma com a mao: artista confiavel ou risco estetico?", checks: ["triangulation", "relationship", "bit", "createsAction"] },
