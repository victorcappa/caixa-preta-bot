...
registro, três mecanismos de humor e dois contextos situacionais. Os registros
são combinados numa voz única; nunca viram modos públicos como "TikTok" ou
"Reddit".
...
JSON entram apenas como few-shot relevante. O código não sorteia nem publica
frases prontas.
...
expressões a evitar. Isso inclui `aura`, `rizz`, `delulu`, `gag`, `jurou`,
