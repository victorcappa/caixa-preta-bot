...
const AUDIENCE_WARMUP_PROMPT_LIBRARY = [
  ...
  { id: "sp-metro-01", text: "Quem passou hoje por alguma estação da Linha Vermelha do Metrô levanta a mão.", action: "hand", category: "São Paulo", intensity: "light", tags: ["São Paulo", "Metrô", "mobilidade"] },
  { id: "sp-rio-01", text: "Quem cruzou o Tietê ou o Pinheiros para chegar aqui bate o pé uma vez.", action: "feet", category: "São Paulo", intensity: "light", tags: ["São Paulo", "rios", "deslocamento"] },
  ...
  { id: "sp-clima-01", text: "Quem consultou a previsão do tempo de São Paulo e mesmo assim trouxe a roupa errada bate palmas.", action: "clap", category: "São Paulo", intensity: "medium", tags: ["São Paulo", "clima", "cotidiano"] },
  { id: "sp-transito-01", text: "Quem mudou a rota por causa do trânsito de São Paulo estala os dedos.", action: "snap", category: "São Paulo", intensity: "medium", tags: ["São Paulo", "trânsito", "mobilidade"] },
  ...
  { id: "absurd-01", text: "Quem já pediu desculpas para uma máquina levanta a mão.", action: "hand", category: "absurdo", intensity: "strange", surpriseLevel: 1, tags: ["máquina"] },
  { id: "absurd-02", text: "Quem acha que alguma coisa aqui está observando a gente bate palmas.", action: "clap", category: "absurdo", intensity: "strange", surpriseLevel: 3, tags: ["presença"] },
  { id: "absurd-03", text: "Quem tem certeza de que veio por vontade própria fica em silêncio.", action: "silence", category: "absurdo", intensity: "strange", surpriseLevel: 4, tags: ["vontade"] },
  { id: "absurd-04", text: "Olhe para alguém como se essa pessoa tivesse acabado de chegar do futuro.", action: "look", category: "absurdo", intensity: "strange", surpriseLevel: 2, tags: ["ficção"] },
  ...
  { id: "collective-05", text: "Quem está pronto para responder a uma máquina levanta as duas mãos.", action: "hands", category: "coletividade", intensity: "strange", surpriseLevel: 1, progressValue: 7, tags: ["máquina"] },
  { id: "absurd-05", text: "Se você suspeita que esta pergunta foi feita especialmente para você, faça um som.", action: "sound", category: "absurdo", intensity: "strange", surpriseLevel: 4, tags: ["máquina", "presença"] },
  { id: "sp-absurd-01", text: "Quem acredita que São Paulo continuaria funcionando normalmente se o céu fosse desligado fecha os olhos.", action: "eyes", category: "São Paulo", intensity: "strange", surpriseLevel: 3, tags: ["São Paulo", "cidade", "absurdo"] },
  { id: "sp-absurd-02", text: "Aponte para a direção em que você acha que a cidade guarda o seu arquivo de hoje.", action: "point", category: "São Paulo", intensity: "strange", surpriseLevel: 5, tags: ["São Paulo", "arquivo", "vigilância"] },
  ...
  { id: "movement-sit", text: "Quem ainda confia no sistema senta novamente.", action: "sit", category: "movimento", intensity: "strange", surpriseLevel: 2, progressValue: 0, tags: ["confiança"] },
  { id: "gesture-point", text: "Aponte para alguém que parece mais humano do que você.", action: "point", category: "gesto", intensity: "strange", surpriseLevel: 5, tags: ["observação"] },
  ...
  { id: "collective-eyes", text: "Fechem os olhos. Respirem fundo. Abram os olhos ao mesmo tempo.", action: "eyes", category: "coletivo", intensity: "strange", surpriseLevel: 2, progressValue: 8, repeatableProgress: true, feedbackOverride: "ATENÇÃO COMPARTILHADA ......... DETECTADA", tags: ["respiração", "sincronia"] },
  { id: "sound-laugh", text: "Quem está completamente no controle da própria vida ri.", action: "laugh", category: "subjetivo", intensity: "strange", surpriseLevel: 3, tags: ["controle"] }
];
