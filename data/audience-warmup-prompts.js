export const AUDIENCE_WARMUP_ACTIONS = [
  { id: "clap", icon: "👏", label: "Bater palmas", instruction: "bate palmas" },
  { id: "hand", icon: "✋", label: "Levantar a mão", instruction: "levanta a mão" },
  { id: "hands", icon: "🙌", label: "Levantar as duas mãos", instruction: "levanta as duas mãos" },
  { id: "feet", icon: "🦶", label: "Bater os pés", instruction: "bate o pé uma vez" },
  { id: "word", icon: "🗣", label: "Falar uma palavra", instruction: "fala uma palavra" },
  { id: "sound", icon: "🔊", label: "Fazer um som", instruction: "faz um som" },
  { id: "silence", icon: "🤫", label: "Ficar em silêncio", instruction: "fica em silêncio" },
  { id: "look", icon: "👀", label: "Olhar para alguém", instruction: "olha para alguém" }
];
...
export const AUDIENCE_WARMUP_PROMPTS = [
  ...
  { id: "location-02", text: "Quando eu disser três, todo mundo fala ao mesmo tempo o bairro onde mora.", action: "word", category: "localização", intensity: "light", countdown: true, tags: ["bairro", "coro"] },
  ...
  { id: "work-02", text: "Quando eu disser três, diga uma palavra que descreve seu trabalho.", action: "word", category: "trabalho", intensity: "light", countdown: true, tags: ["coro"] },
  ...
  { id: "collective-01", text: "Quando eu disser três, todo mundo fala seu primeiro nome ao mesmo tempo.", action: "word", category: "coletividade", intensity: "light", countdown: true, tags: ["nome", "coro"] },
  { id: "collective-02", text: "Vamos respirar juntos e, no fim, fazer um único som.", action: "sound", category: "coletividade", intensity: "medium", tags: ["respiração"] },
  ...
  { id: "collective-05", text: "Quem está pronto para responder a uma máquina levanta as duas mãos.", action: "hands", category: "coletividade", intensity: "strange", tags: ["máquina"] },
